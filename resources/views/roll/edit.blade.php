<form action="/roll/{{$roll->kode_roll}}/update" method="POST" id="frmIRoll">
    @csrf
    ...
    <div class="col-12">
        <div class="input-icon mb-3">
            ...
            <input type="text" value="{{$roll->kode_roll}}" class="form-control" name="kode_roll" id="kode_roll"
                placeholder="KODE ROLL" readonly>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="nama_roll" name="nama_roll" value="{{$roll->nama_roll}}"
