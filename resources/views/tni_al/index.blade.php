                                        ...
                                        <div class="row">
                                            <div class="col-2">
                                                <div class="form-group">
                                                    <input type="text" class="text form-control" id="nrp"
                                                        name="nrp" placeholder="Cari NRP" value="{{ Request('nrp') }}">
                                                </div>
                                            </div>

                                            <div class="col-3">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" id= "nama_prajurit"
                                                        name="nama_prajurit" placeholder="Nama Prajurit"
                                                        value="{{ Request('nama_prajurit') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-3">
                                                <div class="form-group">
                                                    <select name="nama_kot" id="nama_kot" class="form-select">
                                                        ...
                                                        @foreach ($kotama as $d)
                                                            <option
                                                                {{ Request('nama_kot') == $d->kode_kot ? 'selected' : '' }}
                                                                value="{{ $d->kode_kot }}">
                                                                {{ $d->nama_kot }} </option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <tbody>
                                            @foreach ($tni_al as $d)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if (empty($d->foto))
                                                            <img src="{{ asset('assets/img/nophoto.png.png') }}"
                                                                class="avatar" alt="">
                                                        @else
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <form action="/tni_al/{{ $d->nrp }}/delete"
