        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ request()->is(['tni_al', 'kotama', 'roll', 'departemen', 'satuan']) ? 'show' : '' }}"
                        href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                        aria-expanded="{{ request()->is(['tni_al', 'kotama', 'roll', 'departemen', 'satuan']) ? 'true' : '' }}">
                        <span
                    ...
                    <div
                        class="dropdown-menu {{ request()->is(['tni_al', 'kotama', 'roll', 'departemen', 'satuan']) ? 'show' : '' }}">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item {{ request()->is(['tni_al']) ? 'active' : '' }}"
                                    href="/tni_al">
                                    Data Prajurt TNI-AL
                                </a>
                                <a class="dropdown-item {{ request()->is(['kotama']) ? 'active' : '' }}"
                                    href="/kotama">
                                    Data Kotama TNI-AL
                                </a>
                                <a class="dropdown-item {{ request()->is(['roll']) ? 'active' : '' }}" href="/roll">
                                    Data Roll TNI-AL
                                </a>
                    ...
                    <div class="dropdown-menu">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                ...
                                <a class="dropdown-item" href="/roll">
                                    Next
                                </a>
